...
int i, max_value;
int P1,P2,P3,P4;
int idx,t,cache_load_rep; 
int f_id, bigbuffsize;
...
void applyPrewitt() {
    ...
    do{ 
        ...
        small_buff[0] = big_buff[bbi - width - 1]; 	// I1
        small_buff[1] = big_buff[bbi - width]; 		// I2
        small_buff[2] = big_buff[bbi - width + 1];	// I3
        small_buff[3] = big_buff[bbi - 1];			// I4
        small_buff[4] = big_buff[bbi];				// I5
        small_buff[5] = big_buff[bbi + 1];			// I6
        small_buff[6] = big_buff[bbi + width - 1];	// I7
        small_buff[7] = big_buff[bbi + width];		// I8
        small_buff[8] = big_buff[bbi + width + 1];	// I9
        small_buff[9] = big_buff[bbi - width + 2];	// I10
        small_buff[10] = big_buff[bbi + 2];			// I11
        small_buff[11] = big_buff[bbi + width + 2];	// I12
        ...
        oic += 2; // because of the if statements(reads) 
...
void applyRobertsCross() { 
    ...
    do{
        ...
        small_buff[2] = big_buff[bbi + width];		// I3
        small_buff[3] = big_buff[bbi + width + 1];	// I4
        small_buff[4] = big_buff[bbi + 2];			// I5
        small_buff[5] = big_buff[bbi + width + 2];	// I6
        small_buff[6] = big_buff[bbi + 3];			// I7
        small_buff[7] = big_buff[bbi + width + 3];	// I8
        small_buff[8] = big_buff[bbi + 4];			// I9
        small_buff[9] = big_buff[bbi + width + 4];	// I10
        ...
        bbc += 10;
		oic += 4; // because of the initializations and the if statements         
        sbc += 16;
