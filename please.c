...
int main() {
    ...
    input_image = readPPM("bike.ppm", &width, &height, &channels);
    if (input_image == NULL) {
    ...
    writePPM("prewitt_output.ppm", filtered_image, width, height, 1);
    ...
    writePPM("roberts_output.ppm", filtered_image, width, height, 1);
